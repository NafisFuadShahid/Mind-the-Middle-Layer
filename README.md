# Middle Layer: See the middle layer
...
The site is named **Middle Layer**; the repository retains the paper's name, **Mind-the-Middle-Layer**.
...
For initial setup, enable **Settings → Pages → Build and deployment → Source → GitHub Actions** in this repository, then push `main` or run **Publish Middle Layer** from the Actions tab. The repository administrator must be authenticated. See the [GitHub Pages workflow documentation](https://docs.github.com/en/pages/getting-started-with-github-pages/using-custom-workflows-with-github-pages).
